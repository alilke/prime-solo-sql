...
INSERT INTO accounts (username, city, transactions_completed, transactions_attempted, account_balance) VALUES ('angela', 'minneapolis', 5, 10, 100355.80);
...
UPDATE "accounts" SET "city" = 'Sante Fe' WHERE "username" LIKE 'anthony';
--	2	Grace closed her account.
DELETE FROM "accounts" WHERE "username" LIKE 'grace';
